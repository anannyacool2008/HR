<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_out_hr");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_out_hr");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: hrinterview.HRInterview
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_out_hr</label>
                            		<div class="div_texbox">
                              		<input name="out_out_hr" type="text" class="textbox" id="out_out_hr" value="${out_out_hr}" />
                            		</div>
