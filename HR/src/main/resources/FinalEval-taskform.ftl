<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_accept");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_accept");
							myInputs[j].focus();
							return false;
						}
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_accept</label>
                            		<div class="div_checkbox">
                              		<input name="out_accept" type="checkbox" class="checkbox" id="out_accept" value="${out_accept}" />
                            		</div>
